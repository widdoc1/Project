      subroutine scaleset(rscalestart,fscalestart,resumscalestart,p)
...
c--- routines for exact definitions of the scales.
      ...
      include 'first.f'
      include 'part.f'
      double precision rscalestart,fscalestart,resumscalestart,
     & p(mxpart,4),mu0,alphas
      ...
      resumscale=resumscalestart*mu0
