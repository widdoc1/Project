...
c      call checkgvec(-1,2,5,p,qq_tbg,qq_tbg_gvec)
     ...
     .   .or. (case .eq. 'vlchwg') .or. (case .eq. 'vlchwh')) then
        ...
        write(6,*) 'Unimplemented process in resum_LL : case=',case
        stop 
      endif
